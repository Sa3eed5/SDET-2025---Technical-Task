...
module.exports = {
  ...
  src_folders: ["tests"],
  // prevent skipping tests when the src_folders is not specified
  skip_test_sources: false, 
  page_objects_path: ['nightwatch/page-objects'], // Path to your page objects
  ...
  test_settings: {
    default: {
      ...
      skipgroup: [], // don't skip any group
